...
- **Nosaki timer (global/shared)**:
  - Starts when Nosaki/Nosaki Kai is in position 1 or 2 with companion ships.
...
✓ Expedition departure resets the repair timer for fleets containing repair ships
