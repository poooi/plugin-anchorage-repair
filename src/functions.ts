...
export const MINOR_PERCENT = 0.5 // minor damage determination: HP > 50% (小破 or better)
export const MODERATE_PERCENT = 0.5 // moderate damage threshold: HP > 50% (not 中破 or worse)
